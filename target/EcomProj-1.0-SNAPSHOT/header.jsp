...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
    <a class="navbar-brand" href="http://localhost:${pageContext.request.localPort}${pageContext.request.contextPath}/index.jsp" style="color: #e31e57; font-size: 85px; font-family: licida calligraphy; font-style: inherit">Fiesta Meal</a>
