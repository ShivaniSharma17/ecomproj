    ...
    <body style="background-color:  #b7fcb7" >
    ...
    <img class="d-block w-100" style="height: 400px;" src="images/17.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
    <img class="d-block w-100" style="height: 400px;" src="images/18.jpeg" alt="Second slide">
    </div>
    <div class="carousel-item">
    <img class="d-block w-100" style="height: 400px;" src="images/19.jpg" alt="Third slide">
    </div>
    <div class="carousel-item">
    <img class="d-block w-100" style="height: 400px;" src="images/20.jpg" alt="Fourth slide">
    </div>
    </div>
      ...
      <!---        left and right bar ---->
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-3">
                    <ul class="list-group">
                        <li class="list-group-item" style="background-color: green; color: white;"><h4>Menu<h4></li>
